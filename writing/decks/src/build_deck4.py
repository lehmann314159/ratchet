...
DECK = 4
LABEL = "RATCHET · PART 4/4 · THE BURN-IN"
prs = new_deck()
TOTAL = 18

title_slide(prs, DECK, "The Burn-In",
    "The week the team stopped building it and just ran it, honestly",
    "Part 4 of 4 — the last piece. A deliberate stress-test of everything in the first "
    "three pieces: what it found, and what surprised even the people running it.",
    title_size=48)
...
closing_slide(prs, 18, TOTAL, LABEL,
    ...
    "to notice at all. That's the thread running through all four pieces.",
    next_label="End of series. Part 1: Ratchet · Part 2: Verbs and the Fleet · "
               "Part 3: Write for Zero Domain Knowledge.")
...
out = "/Users/mike/Documents/GitHub/ratchet/writing/decks/04-the-burn-in.pptx"
import os
