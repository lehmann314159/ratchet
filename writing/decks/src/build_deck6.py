...
DECK = 6
LABEL = "RATCHET · PART 6/6 · THE BURN-IN"
prs = new_deck()
TOTAL = 18

title_slide(prs, DECK, "The Burn-In",
    "The week the team stopped building it and just ran it, honestly",
    "Part 6 of 6 — the last piece. A deliberate stress-test of everything in the first "
    "five pieces: what it found, and what surprised even the people running it.",
    title_size=48, series_total=6)
...
closing_slide(prs, 18, TOTAL, LABEL,
    ...
    "to notice at all. That's the thread running through all six pieces.",
...
out = "/Users/mike/Documents/GitHub/ratchet/writing/decks/06-the-burn-in.pptx"
import os
