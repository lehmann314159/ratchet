...
DECK = 3
LABEL = "RATCHET · PART 3/4 · ZERO DOMAIN KNOWLEDGE"
prs = new_deck()
TOTAL = 17
...
title_slide(prs, DECK, "Write for Zero Domain Knowledge",
    ...
    "Part 3 of 4. The single hardest skill in the whole system: removing every gap a small "
...
out = "/Users/mike/Documents/GitHub/ratchet/writing/decks/03-write-for-zero-domain-knowledge.pptx"
import os
