*This is the light, orienting piece. Three deep dives follow it: [the architecture and model fleet](https://claude.ai/code/artifact/79e0d9bd-aa5b-4b84-ac34-690c4e1d9f31) in detail, [the craft of writing specs](https://claude.ai/code/artifact/3638f7a6-2456-4d16-b69c-852b0756ad93) precise enough for small models, and [a full account of the recent burn-in](https://claude.ai/code/artifact/46056184-99b7-4196-a475-170ad8d0f586). Where a claim below deserves more evidence than a paragraph can carry, that's where it's headed.*
...
*Next up: [Verbs and the Fleet](https://claude.ai/code/artifact/79e0d9bd-aa5b-4b84-ac34-690c4e1d9f31), a deep dive into the architecture, the verb pipeline, and the model-fleet bakeoffs in full detail; [Write for Zero Domain Knowledge](https://claude.ai/code/artifact/3638f7a6-2456-4d16-b69c-852b0756ad93), on the design-doc craft and the precision tooling built around it; and [The Burn-In](https://claude.ai/code/artifact/46056184-99b7-4196-a475-170ad8d0f586), a full account of the findings.*
